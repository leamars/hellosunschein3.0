      ...
      <div style={styles.display}>
        ...
        <div style={styles.row}>
          <div style={styles.content}>
            ...
            <p style={styles.paragraph}>EmoBot is a tiny bot with a playful interface that challenges users to mimic its expression by showing different faces on an 8x8 LED Matrix. If the user shows the right face EmoBot rewards them with a heart emoji and a success sound. And if they get it wrong... it shows a poop.
            </p>
            <img
            ...
            <p style={styles.paragraph}>I had three objectives when making EmoBot:</p>
            ...
            <p style={styles.paragraph}>Below is the full range of 'faces' EmoBot is programmed to display (some clearly better than others - there's only so much you can do with an 8x8 matrix...).
            </p>
            <img
